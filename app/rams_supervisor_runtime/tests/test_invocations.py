...
class AgentCoreInvocationTests(unittest.TestCase):
    ...
    def test_invocation_wraps_existing_run_contract(self):
        ...
        self.assertEqual(report["runtime"]["runtimeObservability"]["schemaVersion"], "3d-rams.runtime-observability.v1")
        self.assertEqual(report["runtime"]["runtimeObservability"]["modelPath"], "deterministic-planner")
        self.assertEqual(report["runtime"]["runtimeObservability"]["modelCallCount"], 0)
        self.assertNotIn("tokenUsage", report["runtime"]["runtimeObservability"])
        self.assertEqual(run["runtime"]["runtimeObservability"], report["runtime"]["runtimeObservability"])
        ...
        self.assertEqual(report["runtime"]["repairAttemptCount"], 0)
        self.assertEqual(report["runtime"]["repairStopReason"], "passed")
        self.assertEqual(report["runtime"]["repairIssueCount"], 0)
