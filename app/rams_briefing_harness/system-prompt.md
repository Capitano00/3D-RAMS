...
Generate a concise briefing and evidence packet grounded in the provided location, hazards, planning context, and source metadata. If live-model drafting is disabled or unavailable, preserve deterministic fallback output. Keep all claims tied to evidence. Do not claim certified RAMS, emergency guidance, legal advice, or approval to work.
